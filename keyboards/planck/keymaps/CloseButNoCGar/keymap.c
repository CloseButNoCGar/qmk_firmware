...
#define BKDEL SHIFT_NO(KC_BSPC, KC_DEL)
...
/* Qwerty
 * ,-----------------------------------------------------------------------------------.
 * |   Q  |   W  |   E  |   R  |   T  | TAB  |Bs    |   Y  |   U  |   I  |   O  |   P  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   A  |   S  |   D  |   F  |   G  | ESC  |  '   |   H  |   J  |   K  |   L  |   ;  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   Z  |   X  |   C  |   V  |   B  | CTRL |  GUI |   N  |   M  |   ,  |   .  |   /  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Backli| MMode| MTog | Mouse|Lower | Space/Shift |Raise |En/Alt| Vol+ | Vol- | Mute |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
  ...
  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LCTL, KC_LGUI,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
  BACKLIT, MU_MOD,  MU_TOG,  MOUSE,   LOWER,   SPCSFT,  SPCSFT,   RAISE,   ENTALT,  KC_VOLU, KC_VOLD, KC_MUTE
),
